    ...
    <footer className="mt-16 mb-6 text-center">
      ...
      <div className="flex flex-col items-center justify-center space-y-3">
        <div className="flex items-center text-gray-600">
          ...
          <span>by <span className="text-blue-600 font-medium hover:underline cursor-pointer">@Anurag</span></span>
        </div>
        ...
        <div className="flex items-center space-x-6 mt-4">
          <a 
            href="https://github.com/anurag8565" 
            target="_blank" 
          ...
          <a 
            href="https://www.linkedin.com/in/anurag9981" 
            target="_blank" 
            rel="noopener noreferrer"
            className="text-gray-600 hover:text-blue-600 transition-colors duration-300 transform hover:scale-110"
          >
